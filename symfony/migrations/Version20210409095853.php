 ...
 */
final class Version20210409095853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE icapps_devices ADD CONSTRAINT FK_32D6C7ACA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }

(self["webpackChunk"] = self["webpackChunk"] || []).push([["password"],{
...
(function ($) {
  ...
  $(document).on('click', '#toggle-password-icon', function () {
    $('#password_reset_password').attr('type', function (index, attr) {
  ...
  $('#password_reset_password').keyup(function () {
    var pw_reset_button = $('#password_reset_submit');
    var pw_toggle_button = $('#toggle-password-icon');
    var pw_strength_text = $('#password-strength-text');
    var pw_info_text = $('#password-info-text');
    var pw_length = this.value.length;
  ...
  var changeText = function changeText(el, text, color) {
